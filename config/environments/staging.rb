Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "botchain-example-service_#{Rails.env}"

  config.action_mailer.perform_caching = false

  config.action_mailer.default_url_options = { host: '18.188.231.26' }
  config.action_mailer.asset_host = 'http://18.188.231.26'
