        ...
        return (
            <form onSubmit={handleSubmit}>
                <Field name="name" type="text"
                    component={inputField} label="Name" placeholder="Your name"
                    validate={[ required(), length({ max: 36 }) ]}
                />
                ...
                <Field name="password_confirmation" type="password" component={inputField}
                    label="Password confirmation" placeholder="Password confirmation"
                    validate={[ required(), length({ min: 8 }) ]} />
                <Field name="age" type="checkbox" component={checkboxField}
                    label="I confirm that I am 18 years or older"
                    validate={acceptance({message: "Must be at least 18 years old"})} />
